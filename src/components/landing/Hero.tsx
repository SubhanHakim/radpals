            ...
            <div className="z-10 w-full max-w-7xl px-4 flex flex-col items-center justify-end h-full pb-20 space-y-8">
                <div className="text-center space-y-6 max-w-2xl mx-auto">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-[#ccff00]/30 bg-[#ccff00]/5 text-[#ccff00] font-mono text-xs tracking-widest uppercase"
                    >
                    ...
                    <motion.div
                        ...
                        className="text-zinc-300 font-mono text-sm md:text-base leading-relaxed tracking-wide space-y-2"
                    >
